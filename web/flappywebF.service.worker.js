...
/** @type {string} */
const CACHE_VERSION = '1756138017|155853207';
/** @type {string} */
const CACHE_PREFIX = 'FlappyBird Tutor-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'flappywebF.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["flappywebF.html","flappywebF.js","flappywebF.offline.html","flappywebF.icon.png","flappywebF.apple-touch-icon.png","flappywebF.audio.worklet.js","flappywebF.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["flappywebF.wasm","flappywebF.pck"];
